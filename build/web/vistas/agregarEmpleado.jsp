            ...
            <div class="card-body">
                ...
                <div class="container">
                    ...
                    <div class="well well-sm">
                        <form class="form-horizontal" action="empleadocontroller?menu=addEmpleado" method="POST">
                            <fieldset>
                                <div class="row">
                                    <legend class="text-center header" id="title_ventana">AGREGAR EMPLEADO</legend>
                                    <br><br><br>
                                    ...
                                    <br><br>
                                    <div class="form-group col-lg-6 col-sm-6 col-xl-6 col-6 col-md-6">
                                        <input id="fname" name="txtNumeroCelular" type="text" placeholder="Celular" class="form-control">
